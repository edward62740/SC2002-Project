...
public class StaffController {        
	...
	public static boolean run() {
		...
		do {
			...
			System.out.println("6. Reply Suggestions");
	...
	public static void createCamp() {
		...
		Camp newcamp = new Camp(int c_id, String c_name, UserGroup c_userGroup, String c_location, int c_totalSlots, int c_ccmSlots, String c_staff, String c_description);
	...
	public static void replySuggestions() {
